...
namespace ApiVentas.Modelos.Dtos
{
    public class ProductoActualizarDto
    {
        ...
        public List<ProductoProveedorActualizarDto> Proveedores { get; set; } = new List<ProductoProveedorActualizarDto>();
    }

    public class ProductoProveedorActualizarDto
    {
        public int? IdProductoProveedor { get; set; } // null para nuevos registros
